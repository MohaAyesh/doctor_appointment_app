            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="row">
                    <div class="col-md-7 mt-4">
                        <div class="card">
                            <div class="card-header my-3 pb-0 px-3">
                                <h6 class="mb-0">Latest Appointements</h6>
                            </div>
                            <div class="card-body pt-4 p-3">
                                {{-- check appointements is not empty --}}
                                            ...
                                            @if(isset($appointment->date) && $appointment->date != '')
                                                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <div class="flex justify-between">
                                                            <span class="mb-2 text-xs">{{ $appointment->date ?? '-' }}:{{ $appointment->time ?? '-' }}</span>
                                                            <span class="mb-2 text-xs">{{ $appointment->day ?? '-' }}</span>
                                                        </div>
                                                    </div>
                                                </li>
                                            @endif
